...
namespace BloodBankManagementSystem.UI
{
    public partial class frmUsers : Form
    {
        public frmUsers()
        {
            ...
            // Wire up dgvUser_CellClick event handler
            dgvUser.CellClick += dgvUser_CellContentClick;
        }
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            ...
            u.full_name = text_fullname.Text;
            u.email = textBox_Email.Text;
            u.user_name = textBox_username.Text;
            u.password = textBox_password.Text;
            u.contact = textBox_contact.Text;
            u.address = textBox_adresss.Text;
            u.added_by = DateTime.Now;
        ...
        private void dgvUser_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                UserId.Text = dgvUser.Rows[RowIndex].Cells[0].Value.ToString();
                textBox_username.Text = dgvUser.Rows[RowIndex].Cells[1].Value.ToString();
                textBox_Email.Text = dgvUser.Rows[RowIndex].Cells[2].Value.ToString();
                textBox_password.Text = dgvUser.Rows[RowIndex].Cells[3].Value.ToString();
                text_fullname.Text = dgvUser.Rows[RowIndex].Cells[4].Value.ToString();
                textBox_contact.Text = dgvUser.Rows[RowIndex].Cells[5].Value.ToString();
                textBox_adresss.Text = dgvUser.Rows[RowIndex].Cells[6].Value.ToString();
